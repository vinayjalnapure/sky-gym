    ...
    <section id="home" className="relative min-h-[100svh] w-full overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[100svh] max-w-7xl flex-col justify-center px-5 pt-28 pb-28 sm:px-8">
        ...
        <motion.p
          ...
          className="mt-7 max-w-xl text-base leading-relaxed text-soft sm:text-lg"
        >
        ...
        >
          <a
            ...
            className="focus-sky sky-glow bg-sky px-9 py-4 text-center text-sm font-bold tracking-[0.2em] text-ink uppercase transition-colors hover:bg-sky-bright"
          >
            Join Now
          </a>
          <a
      ...
      <a
        href="#about"
        className="focus-sky absolute inset-x-0 bottom-6 mx-auto flex w-fit flex-col items-center gap-2 text-[0.65rem] font-semibold tracking-[0.3em] text-white/60 uppercase"
      >
        Scroll to explore
        <motion.span
